...
public class FilesRecord extends org.jooq.impl.TableRecordImpl<schema.information_schema.tables.records.FilesRecord> {

	private static final long serialVersionUID = 954272181;
	 ...
	 */
	public FilesRecord() {
		super(schema.information_schema.tables.Files.FILES);
	}
