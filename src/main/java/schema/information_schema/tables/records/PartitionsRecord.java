...
public class PartitionsRecord extends org.jooq.impl.TableRecordImpl<schema.information_schema.tables.records.PartitionsRecord> {

	private static final long serialVersionUID = -496236362;
	...
	public PartitionsRecord() {
		super(schema.information_schema.tables.Partitions.PARTITIONS);
	}
