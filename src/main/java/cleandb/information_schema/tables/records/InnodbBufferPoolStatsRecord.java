...
public class InnodbBufferPoolStatsRecord extends org.jooq.impl.TableRecordImpl<cleandb.information_schema.tables.records.InnodbBufferPoolStatsRecord> {

	private static final long serialVersionUID = -162500968;
	...
	public InnodbBufferPoolStatsRecord() {
		super(cleandb.information_schema.tables.InnodbBufferPoolStats.INNODB_BUFFER_POOL_STATS);
	}
