...
public class PartitionsRecord extends org.jooq.impl.TableRecordImpl<cleandb.information_schema.tables.records.PartitionsRecord> {

	private static final long serialVersionUID = 760531254;
	...
	public PartitionsRecord() {
		super(cleandb.information_schema.tables.Partitions.PARTITIONS);
	}
